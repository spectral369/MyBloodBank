...
public class MyHash {
	 ...
	 */
	public static synchronized String getSaltedHash(String password) throws Exception {
	 ...
	 * of the password.
	 */
	public static synchronized boolean check(String password, String stored) throws Exception {
